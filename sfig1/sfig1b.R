...
group1Patient = c(mgbmLabelDf$ID[mgbmLabelDf$bigSmall == 'Big'], mgbmLabelDf$ID[mgbmLabelDf$bigSmall == 'Small'])
group1Label = 'MGBM'
group2Patient = newIdhLabel4sgbmList
group2Label = 'SGBM'
...
ggsurv = ggsurvplot(
  ...
  palette = c('#c994c7', '#2ca25f'), # '#D63821', '#224B89'
