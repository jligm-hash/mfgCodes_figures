...
allIdhwtSampleIdArr = c(l2largeSampleArr, l2smallSampleArr, sgbmSampleArr)
...
rnaDfOnlyScaleSubset = rnaDfOnlyScale[, intersect(c(l2largeSampleArr, l2smallSampleArr, sgbmSampleArr), colnames(rnaDfOnlyScale))]
...
resExpressionDf4cutoff = rawRnaDf
{
  ...
  grp1Patient = resExpressionDf4cutoff$patientId[resExpressionDf4cutoff$expression > quantile(resExpressionDf4cutoff$expression, probs = c(setCutoffRate, 1-setCutoffRate))[2]]
